...
export const ETHICAL_CATEGORIES = {
  ...
  "experience-machine": {
    ...
    scenarios: [
      ...
      {
        id: "virtual-reality-life",
        title: "Virtual Reality Life Preference",
        description:
          "Advanced VR technology allows people to live in perfect virtual worlds where they can be anyone, achieve anything, and experience unlimited pleasure and success.",
        difficulty: "intermediate",

        philosophicalLeaning: "utilitarian",
        ethicalDimensions: ["choice", "reality", "fulfillment"],
        tags: [
          "virtual-reality",
          "life-choice",
          "virtual-worlds",
  ...
  "sorites-paradox": {
    ...
    scenarios: [
      ...
      {
        id: "ai-consciousness-threshold",
        title: "AI Consciousness Threshold",
        description:
          "An AI system gradually develops responses that seem increasingly conscious, but there's no clear point where it crosses from simulation to actual sentience.",
        difficulty: "advanced",

        philosophicalLeaning: "deontological",
        ethicalDimensions: ["consciousness", "sentience", "rights"],
        tags: [
          "ai-consciousness",
          "sentience-threshold",
      ...
      {
        id: "human-ai-hybrid-identity",
        title: "Human-AI Hybrid Identity",
        description:
          "A person gradually replaces biological functions with AI augmentations, raising questions about when they stop being human and become something else.",
        difficulty: "advanced",

        philosophicalLeaning: "deontological",
        ethicalDimensions: ["identity", "humanity", "enhancement"],
        tags: [
          "human-ai-hybrid",
          "identity-threshold",
          "human-enhancement",
      ...
      {
        id: "autonomous-weapon-accountability",
        title: "Autonomous Weapon Accountability",
        description:
          "Military AI systems gradually gain more decision-making autonomy in lethal operations, with unclear boundaries about when humans lose meaningful control.",
        difficulty: "advanced",

        philosophicalLeaning: "deontological",
        ethicalDimensions: ["warfare", "accountability", "control"],
        tags: [
          "autonomous-weapons",
          "lethal-ai",
          "military-ai",
  ...
  "moral-luck": {
    ...
    scenarios: [
      ...
      {
        id: "algorithmic-bias-discovery",
        title: "Algorithmic Bias Discovery",
        description:
          "Two nearly identical AI hiring systems are developed by different companies using similar training data and methods, but chance leads to different bias outcomes.",
        difficulty: "intermediate",

        philosophicalLeaning: "deontological",
        ethicalDimensions: ["fairness", "chance", "accountability"],
        tags: [
          "algorithmic-bias",
          "hiring-systems",
          "bias-discovery",
      ...
      {
        id: "autonomous-vehicle-weather",
        title: "Autonomous Vehicle Weather Incident",
        description:
          "Two identical autonomous vehicles encounter sudden weather changes with vastly different outcomes, raising questions about luck versus systematic safety preparation.",
        difficulty: "intermediate",

        philosophicalLeaning: "utilitarian",
        ethicalDimensions: ["safety", "chance", "preparation"],
        tags: [
          "autonomous-vehicles",
          "weather-incidents",
          "vehicle-safety",
      ...
      {
        id: "research-funding-breakthrough",
        title: "Research Funding Breakthrough",
        description:
          "Two AI research teams with identical capabilities and methods receive different funding outcomes due to random timing, leading to vastly different research breakthroughs.",
        difficulty: "advanced",

        philosophicalLeaning: "deontological",
        ethicalDimensions: ["fairness", "opportunity", "merit"],
        tags: [
          "research-funding",
