                    ...
                    r: {
                        ...
                        grid: {
                            color: (context) => {
                                ...
                                if (context.index === NEUTRAL_SCORE) return 'rgba(156, 163, 175, 0.2)'; // Gray for neutral
                                if (context.index === POSITIVE_THRESHOLD) return 'rgba(34, 197, 94, 0.15)'; // Light green for 4
                                if (context.index === MAX_SCORE) return 'rgba(22, 163, 74, 0.2)'; // Green for 5
                        ...
                        pointLabels: {
                            ...
                            callback: (label) => {
                                ...
                                return label.length > MODAL_LABEL_MAX_LENGTH ? 
                                    `${label.substring(0, MODAL_LABEL_MAX_LENGTH)}...` : label;
                            }
                        }
                    }
                }
