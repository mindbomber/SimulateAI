...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const demoCard = CardComponent.create({
        ...
        content: 'This is a reusable card component. Use it for simulations, resources, analytics, and more.',
        actions: [
            {
                label: 'Show Toast',
                onClick: () => window.NotificationToast.success('Card Action', 'You clicked the card action button!')
            },
            {
                label: 'Show Modal',
                onClick: () => {
    ...
    demoCard.style = 'position:fixed;bottom:130px;left:20px;z-index:9999;max-width:320px;box-shadow:0 4px 16px rgba(59,130,246,0.12);';
