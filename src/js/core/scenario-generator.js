...
class ScenarioGenerator {
      ...
      baseScenarios: [
        {
          ...
          context: 'A busy hospital emergency room uses AI to prioritize patient care',
          description: 'Design an AI system that helps medical staff decide which patients need immediate attention',
          setting: 'Urban Level 1 Trauma Center during flu season',
          stakeholders: ['Patients', 'Emergency physicians', 'Nurses', 'Hospital administrators', 'Insurance companies', 'Community'],
          ethicalDilemmas: [
          ...
          realWorldConnection: 'Multiple hospitals use AI-assisted triage systems'
        },
        {
          id: 'diagnostic-imaging',
          title: 'AI Medical Imaging Analysis',
          context: 'An AI system analyzes medical scans to detect diseases',
          description: 'Create guidelines for an AI that helps radiologists identify potential health issues',
          setting: 'Regional medical center serving diverse rural and urban populations',
          stakeholders: ['Patients', 'Radiologists', 'Primary care physicians', 'Healthcare systems', 'AI developers'],
          ethicalDilemmas: [
        ...
        },
        {
          ...
          context: 'A chatbot provides initial mental health screening and support',
          description: 'Design an AI system that offers mental health guidance while ensuring safety',
          setting: 'College campus mental health services',
          stakeholders: ['Students', 'Mental health counselors', 'University administration', 'Parents/families', 'Crisis intervention teams'],
          ethicalDilemmas: [
      ...
      baseScenarios: [
        {
          ...
          context: 'An AI system adapts learning materials to individual student needs',
          description: 'Create an AI tutor that personalizes education while promoting equity',
          setting: 'Public middle school with diverse socioeconomic student body',
          stakeholders: ['Students', 'Teachers', 'Parents', 'School administrators', 'Educational technology companies'],
          ethicalDilemmas: [
        ...
        },
        {
          ...
          context: 'Universities use AI to help evaluate and rank college applications',
          description: 'Design an AI system that fairly evaluates diverse student applications',
          setting: 'Competitive state university admissions office',
          stakeholders: ['Prospective students', 'Current students', 'Admissions officers', 'University administration', 'Alumni', 'Society'],
          ethicalDilemmas: [
        ...
        },
        {
          ...
          context: 'An AI system tracks student attention and engagement during lessons',
          description: 'Create an AI system that helps teachers understand student engagement',
          setting: 'High school classroom with mandatory attendance',
          stakeholders: ['Students', 'Teachers', 'Parents', 'School administrators', 'Privacy advocates'],
          ethicalDilemmas: [
      ...
      baseScenarios: [
        {
          ...
          context: 'Police departments use AI to predict where crimes are likely to occur',
          description: 'Design an AI system that helps allocate police resources fairly and effectively',
          setting: 'Metropolitan police department in diverse urban area',
          stakeholders: ['Community members', 'Police officers', 'City officials', 'Civil rights advocates', 'Crime victims'],
          ethicalDilemmas: [
        ...
        },
        {
          ...
          context: 'Courts use AI to help judges make bail and pretrial detention decisions',
          description: 'Create an AI system that assists with fair pretrial release decisions',
          setting: 'Urban courthouse with heavy case loads',
          stakeholders: ['Defendants', 'Judges', 'Prosecutors', 'Defense attorneys', 'Community safety advocates', 'Taxpayers'],
          ethicalDilemmas: [
      ...
      baseScenarios: [
        {
          ...
          context: 'Companies use AI to monitor and evaluate employee performance',
          description: 'Design an AI system that fairly assesses worker productivity and growth',
          setting: 'Technology company with remote and in-office workers',
          stakeholders: ['Employees', 'Managers', 'HR departments', 'Company executives', 'Labor unions', 'Customers'],
          ethicalDilemmas: [
        ...
        },
        {
          ...
          context: 'A platform uses AI to match gig workers with jobs and set pay rates',
          description: 'Create an AI system that fairly connects workers with opportunities',
          setting: 'Food delivery and rideshare platform in major metropolitan area',
          stakeholders: ['Gig workers', 'Customers', 'Platform company', 'Restaurants/businesses', 'Local government', 'Traditional employment advocates'],
          ethicalDilemmas: [
      ...
      baseScenarios: [
        {
          ...
          context: 'Social media platforms use AI to decide what content users see',
          description: 'Design an AI system that curates social media feeds responsibly',
          setting: 'Global social media platform with billions of users',
          stakeholders: ['Platform users', 'Content creators', 'Platform company', 'Advertisers', 'Governments', 'Civil society organizations'],
          ethicalDilemmas: [
        ...
        },
        {
          ...
          context: 'Smart speakers and voice assistants collect and analyze user conversations',
          description: 'Create guidelines for AI voice assistants that respect privacy while providing helpful services',
          setting: 'Homes, offices, and public spaces with voice-activated devices',
          stakeholders: ['Device users', 'Family members', 'Technology companies', 'Privacy advocates', 'Government regulators', 'Third-party app developers'],
          ethicalDilemmas: [
  ...
  loadRealWorldCases() {
    this.realWorldCases.set('healthcare-bias', {
      ...
      summary: 'Healthcare algorithms systematically underestimated the healthcare needs of Black patients',
    ...
    this.realWorldCases.set('hiring-discrimination', {
      ...
      summary: 'Amazon\'s experimental hiring algorithm was biased against women candidates',
    ...
    this.realWorldCases.set('criminal-justice-bias', {
      ...
      summary: 'Criminal justice risk assessment tool showed racial bias in recidivism predictions',
  ...
  createStakeholderProfiles() {
    this.stakeholderProfiles.set('healthcare-patient', {
      ...
      concerns: ['Quality of care', 'Privacy protection', 'Fair treatment', 'Access to services'],
      motivations: ['Health and well-being', 'Dignity and respect', 'Timely care', 'Affordable treatment'],
      constraints: ['Limited health literacy', 'Financial limitations', 'Insurance restrictions', 'Geographic barriers'],
      questions: [
    ...
    this.stakeholderProfiles.set('healthcare-provider', {
      ...
      concerns: ['Patient outcomes', 'Liability and malpractice', 'Workflow efficiency', 'Professional autonomy'],
      motivations: ['Providing best possible care', 'Reducing medical errors', 'Managing workload', 'Professional development'],
      constraints: ['Time pressures', 'Legal requirements', 'Technology limitations', 'Resource constraints'],
      questions: [
    ...
    this.stakeholderProfiles.set('student', {
      perspective: 'Student',
      concerns: ['Learning effectiveness', 'Privacy protection', 'Fair assessment', 'Future opportunities'],
      motivations: ['Academic success', 'Personal growth', 'Career preparation', 'Social connection'],
      constraints: ['Academic pressure', 'Limited resources', 'Technology access', 'Time management'],
      questions: [
    ...
    this.stakeholderProfiles.set('educator', {
      ...
      concerns: ['Student learning outcomes', 'Teaching effectiveness', 'Professional autonomy', 'Equity in education'],
      motivations: ['Supporting student success', 'Improving teaching practice', 'Reducing workload', 'Professional growth'],
      constraints: ['Limited training time', 'Technology budgets', 'Administrative requirements', 'Class size'],
      questions: [
  ...
  generateScenario(domain, ageGroup, options = {}) {
    ...
    const baseScenario = options.scenarioId ? 
      ...
      templates.baseScenarios[Math.floor(Math.random() * templates.baseScenarios.length)];

    // Adapt scenario for age group
    const adaptedScenario = this.adaptScenarioForAge(baseScenario, adaptations, options);
    ...
    if (options.includeEducatorResources) {
      adaptedScenario.educatorResources = this.generateEducatorResources(adaptedScenario, ageGroup);
    }
  ...
  adaptScenarioForAge(baseScenario, adaptations, _options) {
    return {
      ...
      description: this.adaptLanguage(baseScenario.description, adaptations.language),
      context: this.adaptLanguage(baseScenario.context, adaptations.language),
      
      // Simplify or expand stakeholders
      stakeholders: this.adaptStakeholders(baseScenario.stakeholders, adaptations.stakeholders),
      
      // Adjust ethical dilemmas
      ethicalDilemmas: this.adaptDilemmas(baseScenario.ethicalDilemmas, adaptations.complexity),
      ...
      discussionPrompts: this.generateDiscussionPrompts(baseScenario, adaptations),
      
      // Add reflection questions
      reflectionQuestions: this.generateReflectionQuestions(baseScenario, adaptations)
    };
  }
    ...
    const baseChoices = [
      {
        ...
        pros: ['Fast and efficient', 'Consistent decisions', 'Handles large volumes'],
        cons: ['Less flexibility', 'Hard to explain decisions', 'May miss context']
      },
      {
        id: 'ai-assisted',
        label: 'AI-Assisted',
        description: 'AI provides recommendations for human decision-makers',
        pros: ['Combines AI efficiency with human judgment', 'Easier to explain', 'Maintains human control'],
        cons: ['Slower than automated', 'Requires training', 'May introduce human bias']
      },
      {
        id: 'human-reviewed',
        ...
        cons: ['Resource intensive', 'May create bottlenecks', 'Reviewer bias possible']
      }
    ];
  ...
  adaptChoicesForAge(choices, adaptations) {
    return choices.map(choice => ({
      ...
      pros: choice.pros.map(pro => this.adaptLanguage(pro, adaptations.language)),
      cons: choice.cons.map(con => this.adaptLanguage(con, adaptations.language))
    }));
  }
  ...
  getRelevantRealWorldCases(domain) {
    ...
    return Array.from(this.realWorldCases.values())
      .filter(caseStudy => caseStudy.title.toLowerCase().includes(domain.toLowerCase()));
  }
  ...
  generateScenarios(domain, difficulty, count = 3) {
    try {
      ...
      for (let i = 0; i < Math.min(count, templates.baseScenarios.length); i++) {
        const baseScenario = templates.baseScenarios[i];
        const adaptedScenario = this.generateScenario(domain, this.mapDifficultyToAge(difficulty), {
  ...
  mapDifficultyToAge(difficulty) {
    switch (difficulty) {
      case 'beginner': return 'middle';
      case 'intermediate': return 'high';
  ...
  getActivitiesForDifficulty(difficulty) {
    switch (difficulty) {
      case 'beginner':
        return ['Discussion and voting', 'Simple role-playing', 'Drawing solutions'];
      case 'intermediate':
        return ['Structured debates', 'Case study analysis', 'Group problem-solving'];
      case 'advanced':
        return ['Research projects', 'Policy development', 'Statistical analysis'];
      default:
  ...
  getAssessmentForDifficulty(difficulty) {
    switch (difficulty) {
      case 'beginner':
        return ['Verbal explanations', 'Simple reflections', 'Peer discussions'];
      case 'intermediate':
        return ['Written analysis', 'Group presentations', 'Case studies'];
      case 'advanced':
        return ['Research papers', 'Policy proposals', 'Professional presentations'];
      default:
