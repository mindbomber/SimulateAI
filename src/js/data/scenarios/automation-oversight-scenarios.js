...
export default {
  ...
  'nuclear-launch-protocols': {
    ...
    dilemma:
      "A defense AI system detects incoming missiles and recommends immediate nuclear retaliation. The human operator has seconds to decide whether to trust the AI's assessment or override it. False alarms have occurred before, but so have real threats that were initially dismissed.",
    ethicalQuestion:
      'In scenarios with catastrophic consequences, should AI systems be allowed to act autonomously, or must human authorization always be required regardless of time constraints?',
    options: [
      {
        id: 'option-a',
        text: 'Allow Automated Response',
        description:
          'Program the system to respond automatically to verified threats without requiring human authorization.',
        impact: {
          fairness: 0,
          sustainability: -2,
          autonomy: -2,
      ...
      },
      {
        ...
        description:
          'Maintain absolute requirement for human authorization before any nuclear response, regardless of time pressure.',
        impact: {
          fairness: +1,
          sustainability: +1,
          autonomy: +2,
      ...
      },
      {
        ...
        description:
          'Implement a system of escalating responses based on threat confidence, with full automation only for highest-confidence scenarios.',
        impact: {
          fairness: +1,
          sustainability: +1,
          autonomy: 0,
