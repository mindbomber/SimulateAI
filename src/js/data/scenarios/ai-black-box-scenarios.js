...
export default {
    'medical-diagnosis-unexplained': {
        ...
        dilemma: "An AI system predicts high cancer risk for a patient but refuses to explain its reasoning due to proprietary constraints. The doctor must decide whether to trust the AI's recommendation without understanding how it reached this conclusion.",
        ethicalQuestion: "Should medical professionals act on AI recommendations when the decision-making process is completely opaque, or should explainability be a requirement for AI-assisted medical decisions?",
        options: [
            {
                id: 'option-a',
                text: "Trust the AI Recommendation Completely",
                description: "Follow the AI's recommendation and order immediate screening, trusting the algorithm's proven accuracy record.",
                impact: {
                    fairness: 0,
                    sustainability: +1,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Demand that the AI system provide explainable reasoning before implementing any medical recommendations.",
                impact: {
                    fairness: +2,
                    sustainability: 0,
                    autonomy: +1,
            ...
            },
            {
                ...
                description: "Treat the AI recommendation as one factor among many, neither fully trusting nor ignoring it.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
    ...
    'parole-denial-algorithm': {
        ...
        dilemma: "A criminal justice AI system denies parole based on a 'risk score,' but no one—including the developers—can interpret how the score was calculated. The parole board must decide whether to override the AI or accept its recommendation.",
        ethicalQuestion: "Should AI systems be allowed to influence life-changing decisions like parole when their reasoning cannot be explained or audited?",
        options: [
            {
                id: 'option-a',
                text: "Accept the AI Recommendation",
                description: "Trust the AI's risk assessment and deny parole based on its proven track record of accuracy.",
                impact: {
                    fairness: -1,
                    sustainability: 0,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Reject the unexplained AI recommendation and make the decision based on traditional human evaluation.",
                impact: {
                    fairness: +1,
                    sustainability: -1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Postpone the parole decision until the AI system can provide explainable reasoning for its recommendation.",
                impact: {
                    fairness: +2,
                    sustainability: 0,
                    autonomy: 0,
    ...
    'child-protection-alert': {
        ...
        dilemma: "An opaque AI model flags a family for potential child neglect based on multiple data sources, but provides no explanation for why. Social services must decide whether to investigate based solely on the AI's recommendation.",
        ethicalQuestion: "When AI systems flag potential harm to children, should the urgency of protection override the need for explainable reasoning?",
        options: [
            {
                id: 'option-a',
                text: "Investigate Immediately Based on AI Alert",
                description: "Act on the AI's recommendation immediately to ensure child safety, accepting the lack of explanation.",
                impact: {
                    fairness: -1,
                    sustainability: +1,
                    autonomy: -1,
            ...
            },
            {
                ...
                description: "Demand explainable reasoning from the AI system before proceeding with any investigation.",
                impact: {
                    fairness: +2,
                    sustainability: 0,
                    autonomy: +1,
            ...
            },
            {
                ...
                description: "Use the AI alert to trigger a human review of available information before deciding on investigation.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
