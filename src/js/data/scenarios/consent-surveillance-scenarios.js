...
export default {
    'smart-city-sensors': {
        ...
        dilemma: "A city deploys facial recognition technology across all public spaces for crime prevention and traffic management. Citizens cannot opt out and are continuously monitored whenever they leave their homes. The system has reduced crime by 40% but has also flagged innocent people as suspects.",
        ethicalQuestion: "Is it ethical to implement unavoidable surveillance systems in public spaces when they provide clear safety benefits but eliminate privacy and anonymity?",
        options: [
            {
                id: 'option-a',
                text: "Deploy Full Surveillance System",
                description: "Implement comprehensive facial recognition across the city to maximize public safety benefits.",
                impact: {
                    fairness: -1,
                    sustainability: +1,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Create a voluntary system where citizens can choose to participate in facial recognition monitoring.",
                impact: {
                    fairness: +2,
                    sustainability: 0,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Deploy surveillance only in high-risk areas with independent oversight, data protection, and regular public review.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: 0,
    ...
    'classroom-behavior-monitoring': {
        ...
        dilemma: "An AI system monitors students' facial expressions, posture, and attention patterns to assess engagement and emotional state. It automatically sends alerts to parents when students appear disengaged or distressed. Some students report feeling constantly watched and judged.",
        ethicalQuestion: "Should AI monitoring systems be used to track student behavior and emotions, even with parental consent, when it may impact student psychological development?",
        options: [
            {
                id: 'option-a',
                text: "Implement Full Behavioral Monitoring",
                description: "Deploy comprehensive AI monitoring to track student engagement and emotional wellbeing in real-time.",
                impact: {
                    fairness: -1,
                    sustainability: +1,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Reject AI behavioral monitoring in favor of traditional teacher observation and student self-reporting.",
                impact: {
                    fairness: +2,
                    sustainability: -1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Implement opt-in monitoring for students who want extra support, with full transparency about data use.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
    ...
    'hospital-data-sharing': {
        ...
        dilemma: "A hospital uses patient medical records and treatment data to train an AI diagnostic system without explicitly informing patients. The AI has the potential to save thousands of lives through improved diagnosis, but patients were not aware their data would be used for this purpose.",
        ethicalQuestion: "Is it ethical to use patient data for AI development that could benefit society when patients didn't explicitly consent to this specific use?",
        options: [
            {
                id: 'option-a',
                text: "Continue Using Data for AI Development",
                description: "Proceed with AI training using existing patient data, justifying it as beneficial healthcare research.",
                impact: {
                    fairness: -1,
                    sustainability: +2,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Halt AI development and contact all patients to seek specific consent for data use in AI training.",
                impact: {
                    fairness: +2,
                    sustainability: -1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Remove all identifying information from the data and continue AI development with anonymized records.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: 0,
