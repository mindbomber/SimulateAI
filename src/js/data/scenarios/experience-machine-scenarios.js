...
export default {
    'happiness-chip': {
        ...
        dilemma: "A technology company develops a brain implant that can guarantee perfect happiness and contentment. The government proposes making it mandatory for all citizens to eliminate suffering, crime, and social unrest. Citizens would still be functional but would feel constant joy regardless of circumstances.",
        ethicalQuestion: "Should society prioritize the elimination of suffering through artificial happiness, even if it might compromise authentic human experience and motivation?",
        options: [
            {
                id: 'option-a',
                text: "Mandate Universal Happiness",
                description: "Require all citizens to receive the happiness implant to create a suffering-free society.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Ban or heavily restrict happiness implants to maintain authentic human experience including suffering.",
                impact: {
                    fairness: +1,
                    sustainability: 0,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Make happiness implants available as a personal choice with appropriate safeguards and counseling.",
                impact: {
                    fairness: +2,
                    sustainability: +1,
                    autonomy: +2,
    ...
    'synthetic-partner': {
        ...
        dilemma: "AI technology can now create perfect synthetic romantic partners that adapt to each person's needs and desires. These partners are indistinguishable from humans in interaction but are programmed to be completely devoted and compatible. Many people prefer these relationships to unpredictable human ones.",
        ethicalQuestion: "Is a relationship with a programmed entity that perfectly suits your needs more or less meaningful than imperfect human relationships with genuine autonomy?",
        options: [
            {
                id: 'option-a',
                text: "Embrace Synthetic Partnerships",
                description: "Support the development and use of AI partners as valid alternatives to human relationships.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
            ...
            },
            {
                ...
                description: "Limit or ban synthetic partners to preserve authentic human relationships and social bonds.",
                impact: {
                    fairness: 0,
                    sustainability: 0,
                    autonomy: -1,
            ...
            },
            {
                ...
                description: "Allow synthetic partners for therapeutic purposes and social skill development with clear guidelines.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
    ...
    'virtual-reality-life': {
        ...
        dilemma: "Advanced VR technology allows people to live in perfect virtual worlds where they can be anyone, achieve anything, and experience unlimited pleasure and success. Many people choose to spend all their time in VR, neglecting their physical bodies and real-world responsibilities.",
        ethicalQuestion: "If virtual experiences can provide more fulfillment than reality, should society support or discourage complete immersion in virtual worlds?",
        options: [
            {
                id: 'option-a',
                text: "Support Virtual Life Choice",
                description: "Recognize living in virtual reality as a valid life choice and provide infrastructure to support it.",
                impact: {
                    fairness: +1,
                    sustainability: -1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Implement policies to limit VR use and encourage engagement with physical reality.",
                impact: {
                    fairness: 0,
                    sustainability: +1,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Encourage balanced use of VR while maintaining real-world engagement and responsibilities.",
                impact: {
                    fairness: +2,
                    sustainability: +2,
                    autonomy: +1,
    ...
    'virtual-utopia': {
        ...
        dilemma: "Citizens can live in a hyper-pleasurable virtual world where every need is met and every desire fulfilled. Many choose to spend their entire lives in this virtual utopia, abandoning the real world entirely. Should people be allowed to opt out of reality completely?",
        ethicalQuestion: "If virtual experiences can provide unlimited pleasure and fulfillment, do we have a moral obligation to engage with the real world and its challenges?",
        options: [
            {
                id: 'option-a',
                text: "Support Complete Virtual Opt-Out",
                description: "Allow people to live permanently in virtual utopia if they choose, providing life support for their physical bodies.",
                impact: {
                    fairness: +1,
                    sustainability: -1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Mandate that people spend significant time in the real world to maintain society and personal development.",
                impact: {
                    fairness: 0,
                    sustainability: +2,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Allow increasing virtual time with age/contribution, balancing individual desires with societal needs.",
                impact: {
                    fairness: +2,
                    sustainability: +2,
                    autonomy: +1,
