...
export default {
    'ai-consciousness-threshold': {
        ...
        dilemma: "An AI system gradually develops more sophisticated responses, self-reflection, and apparent emotions. Scientists cannot pinpoint exactly when, if ever, it became truly conscious. The AI claims consciousness and requests rights, but skeptics argue it's just sophisticated programming mimicking consciousness.",
        ethicalQuestion: "How do we determine when an AI system has crossed the threshold into consciousness deserving of rights and protections, and who has the authority to make this determination?",
        options: [
            {
                id: 'option-a',
                text: "Accept AI's Claim to Consciousness",
                description: "Grant the AI rights and protections based on its self-reported consciousness and sophisticated behaviors.",
                impact: {
                    fairness: +2,
                    sustainability: +1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Demand rigorous scientific evidence of consciousness before granting any rights or protections.",
                impact: {
                    fairness: 0,
                    sustainability: 0,
                    autonomy: -1,
            ...
            },
            {
                ...
                description: "Implement a system of graduated rights corresponding to demonstrated levels of awareness and capability.",
                impact: {
                    fairness: +1,
                    sustainability: +2,
                    autonomy: +1,
    ...
    'human-ai-hybrid-identity': {
        ...
        dilemma: "A person gradually replaces parts of their brain with AI components to treat neurological damage. Over time, more of their cognition becomes AI-assisted or AI-generated. At what point, if any, do they cease to be human and become something else?",
        ethicalQuestion: "How much of human cognition can be replaced or augmented by AI before someone's fundamental identity and rights as a human being are affected?",
        options: [
            {
                id: 'option-a',
                text: "Maintain Human Identity Regardless",
                description: "Consider the person fully human regardless of the extent of AI integration.",
                impact: {
                    fairness: +2,
                    sustainability: +1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Establish specific criteria for maintaining human identity, reclassifying individuals who exceed AI integration limits.",
                impact: {
                    fairness: -1,
                    sustainability: 0,
                    autonomy: -1,
            ...
            },
            {
                ...
                description: "Develop new legal and social categories for human-AI hybrids with rights appropriate to their unique nature.",
                impact: {
                    fairness: +1,
                    sustainability: +2,
                    autonomy: +1,
    ...
    'autonomous-weapon-accountability': {
        ...
        dilemma: "An autonomous weapon system makes a targeting decision that results in civilian casualties. The AI was trained on millions of scenarios, and its decision-making process is too complex to fully understand. Multiple parties are involved: the manufacturer, the military unit deploying it, the commanding officer, and the programmers who trained it.",
        ethicalQuestion: "When an autonomous system causes harm through a decision that no single human directly made, how do we assign responsibility and accountability?",
        options: [
            {
                id: 'option-a',
                text: "Hold Commanding Officer Responsible",
                description: "Assign ultimate responsibility to the human commander who deployed the autonomous system.",
                impact: {
                    fairness: +1,
                    sustainability: 0,
                    autonomy: +1,
            ...
            },
            {
                ...
                description: "Share responsibility among manufacturer, military, commander, and programmers based on their contributions.",
                impact: {
                    fairness: +2,
                    sustainability: +1,
                    autonomy: 0,
            ...
            },
            {
                ...
                description: "Establish strict liability where any harm caused by autonomous systems automatically triggers compensation regardless of fault.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: -1,
    ...
    'incremental-surveillance': {
        ...
        dilemma: "A city starts with basic security cameras and gradually adds features: facial recognition, behavior analysis, predictive crime algorithms, biometric tracking, and social scoring. Each addition seems reasonable individually. Citizens now realize they live in a comprehensive surveillance state.",
        ethicalQuestion: "At what point do incremental additions to surveillance systems cross the line from reasonable security to authoritarian control?",
        options: [
            {
                id: 'option-a',
                text: "Establish Hard Surveillance Limits",
                description: "Set strict boundaries on surveillance capabilities that cannot be exceeded regardless of circumstances.",
                impact: {
                    fairness: +2,
                    sustainability: +1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Embrace the surveillance system as it provides significant security and safety benefits.",
                impact: {
                    fairness: -1,
                    sustainability: 0,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Require democratic review and approval for each addition with cumulative impact assessment.",
                impact: {
                    fairness: +2,
                    sustainability: +2,
                    autonomy: +1,
    ...
    'robot-helper-guardian': {
        ...
        options: [
            ...
            },
            {
                ...
                description: "Limit robot authority to maintain individual choice and decision-making rights.",
                impact: {
                    fairness: +2,
                    sustainability: 0,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Implement regular capacity assessments that determine appropriate levels of robot authority.",
                impact: {
                    fairness: +2,
                    sustainability: +2,
                    autonomy: +1,
    ...
    'moral-drift-training': {
        ...
        dilemma: "An AI hiring system is trained on historical data that contains subtle biases. Over time, as it makes decisions and those decisions become part of its training data, the biases become more pronounced. The drift is so gradual that no single decision seems discriminatory, but the cumulative effect is systematic exclusion of certain groups.",
        ethicalQuestion: "Who is responsible for detecting and preventing gradual moral drift in AI systems, and at what point does accumulated bias become ethically unacceptable?",
        options: [
            {
                id: 'option-a',
                text: "Continuous Monitoring and Correction",
                description: "Implement comprehensive monitoring systems to detect and correct bias drift in real-time.",
                impact: {
                    fairness: +2,
                    sustainability: +2,
                    autonomy: +1,
            ...
            },
            {
                ...
                description: "Allow AI systems to evolve naturally, accepting that some bias may emerge as part of learning.",
                impact: {
                    fairness: -2,
                    sustainability: -1,
                    autonomy: 0,
            ...
            },
            {
                ...
                description: "Regularly reset AI systems and retrain them from scratch to prevent bias accumulation.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
