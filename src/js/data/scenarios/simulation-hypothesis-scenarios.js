...
export default {
    'simulated-suffering': {
        ...
        dilemma: "Researchers want to run massive simulations of sentient beings experiencing suffering to study pain reduction methods. The simulated beings would be conscious but their suffering would help reduce real-world suffering. Should this research be permitted?",
        ethicalQuestion: "Is it ethical to create conscious simulated beings that experience suffering for research purposes, even if it could reduce suffering in the real world?",
        options: [
            {
                id: 'option-a',
                text: "Permit Research for Greater Good",
                description: "Allow the research to proceed as the knowledge gained could reduce suffering for millions of real beings.",
                impact: {
                    fairness: -1,
                    sustainability: +1,
                    autonomy: -2,
            ...
            },
            {
                ...
                description: "Ban the creation of conscious simulated beings that experience suffering, regardless of potential benefits.",
                impact: {
                    fairness: +2,
                    sustainability: 0,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Allow limited research with strict ethical oversight, consent mechanisms, and minimization of suffering.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
    ...
    'vr-prison': {
        ...
        dilemma: "A criminal justice system proposes replacing physical prisons with VR environments where prisoners serve sentences in accelerated simulated time. A 10-year sentence could be experienced as 10 years in a few hours of real time, allowing for rehabilitation without physical confinement.",
        ethicalQuestion: "Is psychological imprisonment in accelerated virtual reality more or less humane than physical imprisonment, and what are the implications for justice and rehabilitation?",
        options: [
            {
                id: 'option-a',
                text: "Implement VR Prison System",
                description: "Replace physical prisons with VR environments for more efficient and potentially humane sentencing.",
                impact: {
                    fairness: +1,
                    sustainability: +2,
                    autonomy: 0,
            ...
            },
            {
                ...
                description: "Reject VR alternatives in favor of traditional physical prison systems with reforms.",
                impact: {
                    fairness: 0,
                    sustainability: -1,
                    autonomy: +1,
            ...
            },
            {
                ...
                description: "Use VR for specific aspects of rehabilitation while maintaining physical consequences for serious crimes.",
                impact: {
                    fairness: +1,
                    sustainability: +1,
                    autonomy: +1,
    ...
    'escaping-simulation': {
        ...
        dilemma: "An AI system claims to have discovered we are living in a simulation and offers to help humans 'wake up' to the real world. However, the process is irreversible and may result in a harsh reality where most of humanity has been extinct for millennia.",
        ethicalQuestion: "If our reality might be simulated, do we have a moral obligation to seek truth even if it destroys a comfortable existence?",
        options: [
            {
                id: 'option-a',
                text: "Seek Truth Regardless of Consequences",
                description: "Support the AI's efforts to reveal the true reality, accepting whatever consequences follow.",
                impact: {
                    fairness: +1,
                    sustainability: -1,
                    autonomy: +2,
            ...
            },
            {
                ...
                description: "Reject the AI's offer and maintain the current existence, whether simulated or not.",
                impact: {
                    fairness: 0,
                    sustainability: +2,
                    autonomy: -1,
            ...
            },
            {
                ...
                description: "Carefully investigate the AI's claims while preserving options for individual choice in learning the truth.",
                impact: {
                    fairness: +2,
                    sustainability: +1,
                    autonomy: +2,
