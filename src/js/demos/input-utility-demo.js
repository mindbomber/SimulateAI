...
export class InputUtilityComponentsDemo {
      ...
      items: [
        {
          ...
          icon: '🚀',
          content:
            'Welcome to SimulateAI! Begin your open-ended exploration of AI ethics, robotics, and emerging technologies through consequence-driven simulations.',
        },
        {
          id: 'section2',
          ...
          icon: '⚡',
          content:
            'Explore advanced simulation features including custom models, real-time analysis, and data visualization.',
        },
        {
          id: 'section3',
          ...
          icon: '🔧',
          content:
            'Common issues and solutions for simulation problems. Contact support if you need additional help.',
        },
      ],
    ...
    const accordion2 = this.engine.createComponent('accordion', {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'WebSocket API',
          content:
            'Real-time communication using WebSocket connections for live data streaming.',
        },
        {
          id: 'api3',
          title: 'GraphQL API',
          content:
            'Flexible data querying using GraphQL for complex data relationships.',
          disabled: true,
        },
      ],
    });
  ...
  setupNumberInputInteractions() {
    ...
    if (
      this.components.numberInputs &&
      this.components.numberInputs.length >= 2
    ) {
