...
export class PriorityComponentsDemo {
    ...
    async init() {
        ...
        const container = document.getElementById('demo-container') || this.createDemoContainer();
    ...
    generateDemoData() {
        const modelTypes = ['CNN', 'RNN', 'Transformer', 'GAN', 'BERT', 'GPT', 'ResNet', 'LSTM'];
        ...
        for (let i = 1; i <= 50; i++) {
            aiModels.push({
                ...
                ethics_rating: ethicsRatings[Math.floor(Math.random() * ethicsRatings.length)],
    ...
    showNotification(message, type = 'info', duration = 4000) {
        ...
        const notificationY = this.notificationContainer.y + (this.notifications.length * 90);
    ...
    createControlButtons() {
        ...
        const successBtn = this.engine.createComponent('button', {
            ...
            height: 35,
            text: 'Success Toast',
            onClick: () => this.showNotification('Operation completed successfully!', 'success')
        });
        ...
        const errorBtn = this.engine.createComponent('button', {
            ...
            height: 35,
            text: 'Error Toast',
            onClick: () => this.showNotification('An error occurred during processing', 'error')
        });
        ...
        const warningBtn = this.engine.createComponent('button', {
            ...
            height: 35,
            text: 'Warning Toast',
            onClick: () => this.showNotification('Model bias detected in results', 'warning')
        });
        ...
        const infoBtn = this.engine.createComponent('button', {
            ...
            height: 35,
            text: 'Info Toast',
            onClick: () => this.showNotification('Training will begin in 30 seconds', 'info')
        });
    ...
    selectAllRows() {
        ...
        if (dataTable) {
            ...
            for (let i = 0; i < pageData.length; i++) {
                const actualIndex = (dataTable.currentPage - 1) * dataTable.pageSize + i;
